      ...
      <div className="w-full max-w-[300px] bg-card border border-border p-[15px] text-center shadow-[0_0px_10px_hsl(var(--outline))] animate-slide-up">
        ...
        <div className="flex flex-col gap-[5px]">
          <Button
            ...
            variant="default"
            className="w-full h-auto bg-primary text-foreground border border-[hsl(var(--inline))] px-[8px] py-[1px] font-mono text-[11px] hover:bg-[hsl(var(--inline))] transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
          >
            Join Discord
          </Button>
          <Button
          ...
          <Button
            ...
            variant="ghost"
            className="w-full h-auto text-foreground hover:bg-[hsl(var(--inline))] px-[8px] py-[1px] font-mono text-[10px] transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] opacity-80 hover:opacity-100 mt-[5px]"
          >
            Terms of Service
          </Button>
        </div>
